...
> ### פתוח
>
> ארבעה, **אף אחד לא חוסם**: כלי פיתוח, ארבע אי-התאמות גאומטריה, פגמי קופי,
> והערה לא-נכונה בקוד.
>
> | # | נושא | חומרה | הערה |
> |---|------|-------|------|
...
> | O5 | אי-התאמות גאומטריה נקודתיות | 🟡 נכונות | §4: subpath בכיוון ליפוף הפוך נעלם; שני פורמטים "קנוניים" סותרים בין `normalize` ל-`frame`; זליגת קואורדינטות בגשרי אות; ה-tokenizer דוחה תחביר SVG חוקי |
