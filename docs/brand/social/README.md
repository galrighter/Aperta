...
| `post-launch-whatsapp.jpg` | 1080×1080 | קארד השקת חברים ומשפחה לוואטסאפ — צמיד כרקע, הדמיית טבעת ושורות הסבר בקארד. המחירים בטקסט המלווה בלבד: [`whatsapp-launch.md`](whatsapp-launch.md) |
