...
// דף הבית הקודם, ככתובת נחיתה ייעודית.
//
// כש-`/` הפך לצומת שני השערים, העמוד הזה לא נמחק אלא עבר לכאן — כמו `/story`,
// הוא דף נחיתה לפרסום ממוקד במסלול אחד (העורך), עם CTA יחיד. מוסתר בניווט
// (אינו ב-NAV) ופתוח לאינדוקס, באותו דגם בדיוק של `/story`.
export const metadata: Metadata = {
  title: s.designYoursTitle,
  description: s.homeMetaDescription,
  alternates: { canonical: "/design-yours" },
  openGraph: {
    title: s.designYoursTitle,
    description: s.homeMetaDescription,
    url: "/design-yours",
...
export default function DesignYoursPage() {
  return (
    <>
      {/* Hero */}
