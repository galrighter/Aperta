 ...
 *
 * `?v=` שנוסע ב-`og:image` אינו נקרא כאן, ובכוונה: תפקידו היחיד הוא להיות
 * כתובת אחרת אחרי שיתוף חוזר שהחליף את התמונה. בלעדיו `immutable` היה משמר
 * לנצח בדיוק את התמונה שהוחלפה. ראו `lib/shareImageUrl`.
 */
