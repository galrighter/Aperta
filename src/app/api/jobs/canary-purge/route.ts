...
// ממתינה לה; זה ניקוי שרץ כל שעתיים, בקצב של הקנרית עצמה. חיבור השניים היה
// מריץ 144 סבבי ניקוי ביום בשביל שורה אחת, ובעיקר היה מערבב בתשובה אחת שני
// דברים שנקראים ביומן המתזמן בנפרד: "מי ממתין" מול "מה כבר לא צריך להיות כאן".
//
