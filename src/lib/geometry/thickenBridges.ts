...
// RM-0068: הגשר שהחזרנו הוא 0.75 מ"מ (הרצפה), והגשרים שהמודל צייר לאותיות
...
//
// על RM-0068 זה מוצא שניים — הקונטור של R (0.71) וזה של ה-e השנייה (0.41) —
 ...
 *
 * 6,000 ולא 3,000 (החלטת גל): המשתמש ממתין ליצירה מעל דקה ממילא, ולקוחה
 * שנוטשת כי לא קיבלה תוצאה יקרה מכמה שניות המתנה. התקרה כאן היא בלם מפני זנב
 * לא חסום, לא איזון מול זמן.
 */
 ...
 * אותם. נמדד על RM-0068: השניים נתנו 0.22 ו-0.73 לאותו צוואר שהוא 0.37.
 *
