...
//
// **הרעיון:** לא לתת למודל התמונה לכתוב בכלל. הוא כותב עברית תקינה אבל לא
// תמיד את המילה שביקשו — בולע יו״ד, מחליף מ׳ ב-ם׳, ומתקן כתיב בשקט
// (`appologize` חזר `APOLOGIZE` בכל הרצה). איות תו-אחר-תו בפרומפט הרע את
// המצב ולא שיפר אותו. לכן הכיתוב נחתך כאן, מהפונט שלנו, ונמסר למודל כתמונת
// ייחוס ל-`images/edits`; הוא רק מעצב סביבו. המדידות והנימוקים המלאים:
// docs/research/HEBREW_TEXT_HANDOFF.md.
//
