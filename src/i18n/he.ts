...
export const he = {
  ...
  emptyBody: "תארו במילים את העיצוב הרצוי — החיתוכים וגם קו המתאר של התכשיט. ה-AI ייצור עיצוב, יבדוק שהוא ניתן לייצור, ותוכלו לעדן אותו בשיחה ובסימונים על הקנבס.",
  examplePrompts: [
    "משושים משורגים בצפיפות בינונית",
    "גלים אורגניים זורמים לאורך הצמיד, שגולשים גם בקצה החיצוני",
  ...
  site: {
    ...
    materialBody:
      "כל פריט נחתך מלוח פליז בעובי 1.5 מ\"מ בחיתוך לייזר סיבים, ואז מעורגל לקשת פתוחה — צמיד או טבעת שנפתחים בעדינות ומתאימים למידה. הלייזר חותך את הפריט כולו: גם החיתוכים שבתוכו וגם קו המתאר החיצוני, שיכול להיות ישר או לגלוש בקצוות — כל עוד המתכת נשארת חזקה אחרי הכיפוף.",
    ...
    step1Title: "מתארים",
    step1Body: "כותבים בשפה חופשית את העיצוב שרוצים — גיאומטרי, אורגני, עדין או נועז; גם החיתוכים וגם הצורה החיצונית. אפשר גם לצרף שרטוט או תמונת השראה.",
    step2Title: "הבינה מציירת",
    step2Body: "המנוע מייצר עיצוב מלא — חיתוכים וקו מתאר — ואפשר לעדן אותו בשיחה: \"תגדיל את זה\", \"פחות צפוף כאן\" — או לסמן ישירות על הקנבס.",
    ...
    faqItems: [
      {
        ...
        a: "מתארים במילים. כותבים משפט כמו \"משושים משורגים בצפיפות בינונית, עם קצה עליון גלי\", והבינה המלאכותית מציירת עיצוב מלא — חיתוכים וקו מתאר. משם מעדנים בשיחה ובסימונים על הקנבס — בלי שום תוכנת גרפיקה.",
      },
      {
    ...
    terms: {
      ...
      sections: [
        { h: "השירות", p: "האתר מאפשר לעצב צמיד או טבעת מפליז — חיתוכים וקו מתאר — באמצעות כלי בינה מלאכותית, ולהפיק קובץ ייצור. עיצוב שנוצר הוא הצעה — ייצור בפועל כפוף לבדיקה ולתיאום נפרד." },
  ...
  design: {
    ...
    briefPlaceholder: "לדוגמה: קווים אלכסוניים דקים שמתעבים לכיוון המרכז, קצה עליון גלי, אזור ריק בצד אחד...",
    briefHint:
      "ככל שיהיה יותר פירוט — כך התוצאה תהיה יותר מדויקת. אפשר לתאר צורות, קצב, אזורים ריקים, את קו המתאר החיצוני, השראה ותחושה.",
    briefSubmit: "שלח",
