      ...
      cases: [
        {
          ...
          body: "מיקי מאוס, הלו קיטי, פוקימון, גיבורי-על, דמויות מסרטי אנימציה. גם בקשה \"בסגנון\" של דמות כזו נחסמת לעיתים. דמות מוגנת לא תיווצר כאן — גם לא בניסוח שמתאר אותה בלי לנקוב בשמה.",
          instead: null,
        },
        {
