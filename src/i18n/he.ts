...
export const he = {
  ...
  site: {
    ...
    terms: {
      title: "תנאי שימוש",
      intro: "השימוש באתר RM JEWEL ובכלי העיצוב שבו כפוף לתנאים שלהלן. עצם השימוש מהווה הסכמה להם.",
      sections: [
        ...
        { h: "קניין רוחני", p: "הכלים, הקוד והמותג שייכים ל-RM JEWEL. עיצוב שיצרתם נשאר שלכם לשימושכם; אין להעלות תוכן שמפר זכויות של צד שלישי." },
