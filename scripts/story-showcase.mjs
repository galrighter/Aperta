...
//
// **מי בפנים נקבע על ידי גל, לא על ידי הקוד.** ברשימה המקורית נכלל AP-0171,
// שאין לו אף גרסה שהושלמה; AP-0170 (אותה בקשה בדיוק) נכנס במקומו — והוסר
// אחר כך לבקשת גל (17.8). הוספה/הסרה של עיצוב היא שורה ב-PICKS והרצה.
//
